...
const {
  ...
  filterMethod,
  transformI18n
} = useCustomer(tableRef, treeRef, menuTreeRef);
            ...
            >
              <template #operation="{ row }">
                ...
                <el-dropdown>
                  ...
                  <template #dropdown>
                    <el-dropdown-menu>
                      <el-dropdown-item @click="handleUser(row)">
                        <el-button
                          v-auth="'customer:saveUserIds'"
                          :class="buttonClass"
                          link
                          type="primary"
                          :size="size"
                      ...
                      <el-dropdown-item @click="handleMenu(row)">
                        <el-button
                          v-auth="'customer:saveMenuIds'"
                          :class="buttonClass"
                          link
                          type="primary"
                          :size="size"
                      ...
                      <el-dropdown-item @click="downloadAuth(row)">
                        <el-button
                          v-auth="'customer:saveMenuIds'"
                          :class="buttonClass"
                          link
