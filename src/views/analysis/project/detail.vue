...
import {
  getProjectSalesDetailListApi,
  type ProjectSalesDetailRow
} from "@/api/analysis/project";
import { getDoctorListApi } from "@/api/analysis/diary";

defineOptions({ name: "AnalysisProjectDetail" });
...
const tableData = ref<ProjectSalesDetailRow[]>([]);
...
const loadList = async () => {
  loading.value = true;
  try {
    const res = await getProjectSalesDetailListApi({
      ...buildParams(),
